...
/* USER CODE BEGIN PV */
const int MAX_LED = 4;
int led_index = 0;                    // LED hiện tại
int led_buffer[4] = {1, 2, 3, 4};     // dữ liệu cần hiển thị
/* USER CODE END PV */
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
    if (htim->Instance == TIM2) {
        ...
        led_index = (led_index + 1) % MAX_LED;  // xoay vòng 0..3
    }
}
...
int main(void)
{
  ...
  while (1)
  {
      // Không cần làm gì thêm, hiển thị chạy trong ngắt
  }
}
