...
const int MAX_LED = 4;
int led_index = 0;
int led_buffer[4] = {1, 5, 0, 8};   // ví dụ: 15:08
int dot_counter = 0;
...
int timer0_flag = 0;
int TIMER_CYCLE = 10;   // ms, phải bằng period timer ngắt
...
static void MX_TIM2_Init(void) {
  ...
  htim2.Init.Period = 249;         // 100ms interrupt
